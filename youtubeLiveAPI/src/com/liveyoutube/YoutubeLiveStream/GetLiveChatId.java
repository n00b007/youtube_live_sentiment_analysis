...
public class GetLiveChatId {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Get the liveChatId
            String liveChatId =
                    args.length == 1 ? getLiveChatId(youtube, args[0]) : getLiveChatId(youtube);
            if (liveChatId != null) {
    ...
    static String getLiveChatId(YouTube youtube) throws IOException {
        ...
        YouTube.LiveBroadcasts.List broadcastList =
                youtube.liveBroadcasts().list("snippet").setFields("items/snippet/liveChatId")
                        .setBroadcastType("all").setBroadcastStatus("active");
